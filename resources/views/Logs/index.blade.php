                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <form method="GET" action="{{ route('Log.index') }}" class="row">
                                <div class="col-auto">
                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="text-white text-capitalize ps-3">Log</h6>
                                <a class="btn btn-outline-white btn-sm mb-1 me-3" href="{{ route('Log.create') }}">
                                    Add Log
                                </a>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $Log->log_name }}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <a class="btn btn-sm text-info mb-0 mt-0"
                                                    href="{{ route('Log.show', $Log->id) }}">View</a>
                                                <br class="mt-0 mb-0">
                                            </td>
                                        </tr>
                                    @empty
